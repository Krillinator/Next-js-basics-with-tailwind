...
export function Button({ name }: ButtonProps) {
  return (
    <button
      className=" bg-sky-400 text-blue-950 font-bold w-32 py-2 
		rounded-md shadow-md shadow-black
		flex justify-center items-center 
		 hover:cursor-pointer hover:bg-sky-300 hover:-translate-y-0.5 transition
		 md:text-base
		 lg:text-2xl
		 xl:text-3xl
		"
